...
#convert snowflake dataframe into pandas dataframe, so we can use LOC function
...
#Storing orders in snowflake
    ...
    if time_to_insert:
        ...
        st.write(st.success('Your Smoothie is ordered'),st.success(name_on_order,icon="✅"))
